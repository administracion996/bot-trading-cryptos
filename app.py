...
with tab1:
    ...
    if cartera:
            ...
            if not df_ventas.empty:
                ...
                with col_g2:
                    ...
                    if not df_gemini.empty:
                        ...
                        st.info("No hay datos de puntuación Gemini registrados en los logs antiguos del historial.")
            else:
        ...
        # 6. HISTORIAL DE OPERACIONES COMPLETO
