...
# Universo ampliado de 28 criptomonedas
UNIVERSO_MERCADO = [
    "BTC-USD",
    "ETH-USD",
    "SOL-USD",
...
# --- CARGA DE DATOS DIRECTA DESDE CARTERA.JSON ---
...
if cartera:
  ...
  # 2. GRÁFICA ORIGINAL DE BARRAS (DISTRIBUCIÓN DE CAPITAL)
  ...
  # 3. TABLA ORIGINAL DE POSICIONES
  ...
  # 4. HISTORIAL ORIGINAL DE OPERACIONES
  ...
  if seleccionadas:
    try:
      df_precios = yf.download(
          seleccionadas, period="1d", interval="15m", progress=False
      )["Close"]
      ...
      st.caption("Gráfica de fluctuación no disponible de forma temporal.")
