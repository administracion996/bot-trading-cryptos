...
if cartera:
                    ...
                    for op in historial_crudo:
                        ...
                        try:
                            ...
                            if ("COMPRA" in op or "INICIO" in op) and (ticker in op or "INICIO" in op):
                                ...
                                pnl_info = f"<br>Beneficio: {match_pnl.group(1)}€" if match_pnl else ""
                                pct_info = f"<br>Rentabilidad: {match_pct.group(1)}%" if match_pct else ""
    ...
    for operacion in historial_crudo:
        ...
        # Añadimos las columnas en el orden exacto que queremos que aparezcan
    ...
    if not df_historial.empty:
        ...
        # Formato de colores y visualización con control de vacíos (NaN)
